...
function aboutView(){
  ...
  content.innerHTML = `<div class="legalpage">
    ...
    <div class="box">This site runs entirely on your own computer as a static, local website. It does <strong>not</strong> collect personal information, set cookies, track you, use analytics, create accounts, or transmit any data to any server. All browsing and searching happen locally in your browser. The only network requests are the official-source links you choose to click, which open pages on capitol.hawaii.gov.</div>
